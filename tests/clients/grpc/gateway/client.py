...
from contracts.services.gateway.rpc_get_account_details_pb2 import GetAccountDetailsRequest, GetAccountDetailsResponse
from contracts.services.gateway.rpc_get_user_details_pb2 import GetUserDetailsRequest, GetUserDetailsResponse
